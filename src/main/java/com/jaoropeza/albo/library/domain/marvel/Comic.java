...
public class Comic {
    ...
    @JsonProperty("prices")
    private java.util.List<ComicPrice> prices = null;
    ...
    private java.util.List<TextObject> textObjects = null;
    ...
    @JsonProperty("urls")
    private java.util.List<Url> urls = null;
    @JsonProperty("variantDescription")
    private String variantDescription = null;
    @JsonProperty("variants")
    private java.util.List<ComicSummary> variants = null;
